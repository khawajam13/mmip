...
function localize(d1, d2, d3, d4, d5) {
	...
	/* post("dists\n")
	post(dists[0][0] + "; " + dists[0][1] + "\n");
	post(dists[1][0] + "; " + dists[1][1] + "\n");
	post(dists[2][0] + "; " + dists[2][1] + "\n");
	post(dists[3][0] + "; " + dists[3][1] + "\n");
	post(dists[4][0] + "; " + dists[4][1] + "\n");
	*/	
	...
	var angle = (pos[1] == 0) ? 0 : Math.atan2(pos[0] / pos[1]);
