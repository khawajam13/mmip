...
function setSensorLocs(ang1, ang2, ang3, ang4, /*ang5, ang6, ang7, ang8,*/ d1, d2, d3, d4/*, d5, d6, d7, d8*/) {
	...
	s6 = [d6 * Math.sin(ang6 * Math.PI / 180), d6 * Math.cos(ang6 * Math.PI / 180)];
	s7 = [d7 * Math.sin(ang7 * Math.PI / 180), d7 * Math.cos(ang7 * Math.PI / 180)];
	s8 = [d8 * Math.sin(ang8 * Math.PI / 180), d8 * Math.cos(ang8 * Math.PI / 180)];*/
	
	post("Locs = (" + s1.map(fixie) + "), (" + s2.map(fixie) + 
			"), (" + s3.map(fixie) + "), (" + s4.map(fixie) + 
				/*"), (" + s5.map(fixie) + "), (" + s6.map(fixie) + 
				"), (" + s7.map(fixie) + "), (" + s8.map(fixie) +*/ ")\n");
...
function localize(d1, d2, d3, d4/*, d5, d6, d7, d8*/) {
